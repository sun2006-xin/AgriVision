"""Authentication and bounded rate limiting for System A HTTP APIs."""
...
class ApiSecurity:
    """Protect business endpoints while keeping health and docs discoverable."""
    ...
    def is_protected_path(cls, path):
        return path in cls.PROTECTED_EXACT_PATHS or path.startswith("/result/")
